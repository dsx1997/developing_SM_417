                ...
                if ((res.types == "student" || res.types == "staff" || res.types == "teacher" || res.types == "admin")) {
                    ...
                    for (let exam_record of my_class_sub.subject.exam_record) {
                        if (exam_record.my_class_id == my_class_sub.my_class_id && exam_record.exam_id == exam.value && exam_record.af == my_class_sub.subject_id) {
                            ...
                            if (exam_record.ps == 0) {
                                flag = 1;
                                cc += `<td class="text-danger" style="font-family: 'Times New Roman', Times, serif;">Uploaded but not published by subject teacher</td>`;
                            } else {
                                flag = 2;
                                cc += `<td class="text-success" style="font-family: 'Times New Roman', Times, serif;">Pending publishing by class teacher</td>`;
                            }
                            break;
                        }
